...
5. `/pi_agent/agent_profiles/pimatt/CONTEXT.md` for the definitions of project-level
...
Read
`/pi_agent/agent_profiles/pibrain/skills/.agents/skills/second-brain-update/SKILL.md`
