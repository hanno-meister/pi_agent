...
Refresh these two files from immutable commit `e445c99`:

```sh
curl -fsSL https://raw.githubusercontent.com/hanno-meister/pi_agent/e445c99/prototypes/herdr-human-pilot/pilot.sh -o pilot.sh
curl -fsSL https://raw.githubusercontent.com/hanno-meister/pi_agent/e445c99/prototypes/herdr-human-pilot/CHECKLIST.md -o CHECKLIST.md
```
