...
Refresh these two files from immutable commit `d306956`:

```sh
curl -fsSL https://raw.githubusercontent.com/hanno-meister/pi_agent/d306956/prototypes/herdr-human-pilot/pilot.sh -o pilot.sh
curl -fsSL https://raw.githubusercontent.com/hanno-meister/pi_agent/d306956/prototypes/herdr-human-pilot/CHECKLIST.md -o CHECKLIST.md
```
